...
<form id="fm">
    ...
    <select name="classRoom">
        <option
                <c:if test="${user.classRoom==1801}">selected="selected"</c:if> value="1801">1801
        </option>
        <option
                <c:if test="${user.classRoom==1802}">selected="selected"</c:if> value="1802">1802
        </option>
        <option
                <c:if test="${user.classRoom==1803}">selected="selected"</c:if> value="1803">1803
        </option>
        <option
                <c:if test="${user.classRoom==1804}">selected="selected"</c:if> value="1804">1804
        </option>
        <option
                <c:if test="${user.classRoom==1805}">selected="selected"</c:if> value="1805">1805
        </option>
        <option
                <c:if test="${user.classRoom==1806}">selected="selected"</c:if> value="1806">1806
        </option>
    </select><br>
    爱好:
